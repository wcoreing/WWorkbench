...
export function ListAgentCapabilities() {
  return window['go']['app']['Service']['ListAgentCapabilities']();
}
...
export function SaveAgentAPIConfig(arg1) {
  return window['go']['app']['Service']['SaveAgentAPIConfig'](arg1);
}

export function SaveAgentPermissions(arg1) {
  return window['go']['app']['Service']['SaveAgentPermissions'](arg1);
}
...
export function TestAgentConnection() {
  return window['go']['app']['Service']['TestAgentConnection']();
}

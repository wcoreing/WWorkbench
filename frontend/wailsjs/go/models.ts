export namespace app {
	...
	export class ApiResult_WWorkbench_internal_model_HTTPResponseDO_ {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ok = source["ok"];
	        this.data = this.convertValues(source["data"], model.HTTPResponseDO);
	        this.error = this.convertValues(source["error"], errno.AppError);
	    }
	...
	export class ApiResult_WWorkbench_internal_model_HTTPSavedRequestDO_ {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ok = source["ok"];
	        this.data = this.convertValues(source["data"], model.HTTPSavedRequestDO);
	        this.error = this.convertValues(source["error"], errno.AppError);
	    }
	...
	export class ApiResult_WWorkbench_internal_model_MCPStatusDO_ {
	    ok: boolean;
	    data: model.MCPStatusDO;
	    error?: errno.AppError;
	
	    static createFrom(source: any = {}) {
	        return new ApiResult_WWorkbench_internal_model_MCPStatusDO_(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ok = source["ok"];
	        this.data = this.convertValues(source["data"], model.MCPStatusDO);
	        this.error = this.convertValues(source["error"], errno.AppError);
	    }
	...
	export class ApiResult_WWorkbench_internal_model_SSHForwardActiveDO_ {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ok = source["ok"];
	        this.data = this.convertValues(source["data"], model.SSHForwardActiveDO);
	        this.error = this.convertValues(source["error"], errno.AppError);
	    }
	...
	export class ApiResult_WWorkbench_internal_model_SSHForwardPresetDO_ {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ok = source["ok"];
	        this.data = this.convertValues(source["data"], model.SSHForwardPresetDO);
	        this.error = this.convertValues(source["error"], errno.AppError);
	    }
...
export namespace model {
	...
	export class HTTPHeaderKVDO {
	    ...
	    static createFrom(source: any = {}) {
	        return new HTTPHeaderKVDO(source);
	    }
	...
	export class HTTPExecuteRequestDO {
	    method: string;
	    url: string;
	...
	export class HTTPResponseDO {
	    ...
	    static createFrom(source: any = {}) {
	        return new HTTPResponseDO(source);
	    }
	...
	export class HTTPSavedRequestDO {
	    ...
	    static createFrom(source: any = {}) {
	        return new HTTPSavedRequestDO(source);
	    }
	...
	export class MCPConfigSaveDO {
	    enabled: boolean;
	    addr: string;
	
	    static createFrom(source: any = {}) {
	        return new MCPConfigSaveDO(source);
	    }
	...
	export class MCPStatusDO {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.workbenchUrl = source["workbenchUrl"];
	...
	export class SSHForwardActiveDO {
	    ...
	    static createFrom(source: any = {}) {
	        return new SSHForwardActiveDO(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.name = source["name"];
	        this.sshHostId = source["sshHostId"];
	        this.sshHostName = source["sshHostName"];
	...
	export class SSHForwardPresetDO {
	    id: string;
	    name: string;
	    sshHostId: string;
	    localPort: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new SSHForwardPresetDO(source);
	    }
	...
	export class SSHForwardStartDO {
	    presetId: string;
	    name: string;
	    sshHostId: string;
	    localPort: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new SSHForwardStartDO(source);
	    }
